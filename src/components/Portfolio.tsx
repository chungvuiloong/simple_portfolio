...
const projects = [
  ...
  // Web Development Projects
  {
    ...
    description:
      <>
        This is a challenge from <a href="https://www.frontendmentor.io/" className='underline underline-offset-4'>Frontend Mentor</a>.
        Access the challenge from <a href="https://www.frontendmentor.io/challenges/workit-landing-page-2fYnyle5lu" className='underline underline-offset-4'>here</a>
     </>,
    imageUrl: 'project1.jpg',
    host: 'Vercel',
    ...
    return (
      <div className='flex flex-col border-l-4 border-l-[#00224c]'>
        {categories.map((category) => (
          <Button
            key={category.id}
            className={`px-6 py-2 rounded-tl-none rounded-bl-none rounded-r-3xl text-left xl:text-xl lg:text-md text-xs ${
