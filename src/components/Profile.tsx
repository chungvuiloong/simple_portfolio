...
//                 color="white"
//                 variant="h1"
//                 className="mt-6 xl:text-[16rem] lg:text-[13rem] md:text-[10rem] text-[5rem] tracking-tighter"
//               >
//                 Hi there!
//                 <br />
//               </Typography>
...
//                 color="white"
//                 variant="paragraph"
//                 className="mt-6 text-left md:text-4xl text-md text-black opacity-50"
//               >
//                 I am "Jere" Vui Loong Chung. <br />A developer who is passionate
//                 about{""}
//                 <br />
//               </Typography>
//             </div>
